...
-- Description:	Get Page Attributes
-- =============================================
CREATE PROCEDURE PEC.MG_PROMOTION_GetPageAttributes
...
BEGIN
  ...
  SET @PlayerLang = dbo.GD_SESSION_GetForPlayer (@IPAddress)
	...
	SELECT ggat.TypeName, gga.ObjectName, gga.AttributeName, gga.AttributeValue
  ...
  WHERE gga.GameID = @GameID
    AND ggp.PageName LIKE @PageName
