...
namespace DatabaseModifier
{
    class DataAcess
    {
        // Database Connection String for Test DB
        private static string connectionString = ConfigurationManager.ConnectionStrings["EllisTR"].ConnectionString;

        private static SqlConnection TRConnection = new SqlConnection(connectionString);
